...
//     {/* <div className='w-3/5 h-3/4 bg-gray-800 mt-[12rem] rounded-tr-4xl rounded-br-4xl'>
//     <img 
//         src={AIImage} 
//         className="mt-16 p-4 h-[33rem] w-[52rem] " 
//         alt="Fire Department Monitoring" 
//       />
//     </div> */}
//         <img src={AIImage}  className='w-[50rem] h-3/4  mt-[12rem] rounded-tr-4xl rounded-br-4xl' alt="Fire Department Monitoring" />


//         <div className='h-96'>AI Powered Integrarion</div>
